export const Background = () => {
  return (
    <section className='caret-transparent float-none break-words w-full mb-5 md:float-right md:mb-[60px]'>
      ...
      <div className='caret-transparent break-words rounded-[15px]'>
        <p className='text-slate-400 text-[14.4px] caret-transparent leading-[25.6px] break-words pt-0 pb-[15px] px-0 md:p-[25px]'>
