export const ContactLinks = () => {
  return (
    <div className='flex flex-col'>
      <div className='items-center flexpy-1'>
        <svg
        ...
        <a
          ...
          target='_blank'
          className='blockpl-2 hover:text-slate-50 hover:border-slate-50'
        >
      ...
      <div className='items-center flexpy-1'>
        ...
        <a
          ...
          target='_blank'
          className='block pl-2 hover:text-slate-50 hover:border-slate-50'
        >
          Codepen
        </a>
      </div>
